...
- `share-internal-doc` keeps reader context, supported judgment, and preservation requirements in its core. Load structure, claims, sharing, or medium guidance when the task needs it. Keep house presentation defaults scoped to compatible media; do not turn an individual report's format into a universal outline.
