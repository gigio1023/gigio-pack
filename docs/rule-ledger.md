...
**2026-09-10 — terminology policy revised.** Supersedes the initial opt-in terminology design below: both skills now apply on every task. Research favors established projects, influential papers, author/maintainer blogs, and actively used paper tools; generated derivative prose and user-named projects are excluded as wording authorities. Expression records include verbs and explanation structure. Unrelated procedural skills retain explicit invocation.
