...
| An internal name or metric | Owning code, configuration, data specification, or documented decision | Exact identifier, revision, formula, unit, denominator, and implementation status |
