...
- Research terminology and expressions in established projects' official documents and maintainer blogs, influential papers, and their author explanations. Use available paper tools such as `hf papers` actively. Apply `curate-terminology`'s provenance checks and heightened scrutiny of AI-project wording; AI-generated derivative writing is not a wording authority.
