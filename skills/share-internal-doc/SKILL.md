...
Use insight-dashboard for data views whose comparisons and commentary must remain consistent with selections. Use the appropriate document or figure tool for the requested medium. Do not copy their methods into this package or run an automatic second editorial pass. Explicit AI-slop revision and Korean meaning repair live in technical-report-writing (references/authoring-and-revision.md and references/korean-writing.md), and the author's standing preferences in its references/writing-profile.md; apply them through that skill, once.
...
Return the artifact or findings, its path or URL, and material delivery limitations. Use [composition and migration](references/composition.md) when maintaining this workflow or moving an old document-production copy to its specialist owner.
