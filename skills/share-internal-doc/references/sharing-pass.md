...
Consider both the organization and the person sharing the document. Check for confidential material, unsupported accusations, personal positioning, or wording that makes a factual report read as an evaluation of somebody's character, attitude, or ability.

Keep relevant failures, unresolved problems, and their supporting records. Describe observed behavior or structural conditions rather than assigning motives. Dry wording should preserve the finding's force where it is supported.
...
Generalize private work habits and session details that do not serve the reader. Preserve event times, model versions, system roles, and other particulars when they establish a timeline, explain a result, or enable required reproduction. Replace removed context with an accurate role or explanation rather than leaving a hole.

If the user or organization requires named people to review relevant passages before wider circulation, preserve that requirement and any review already completed. Preparing the passages is in scope; contacting people requires the corresponding authorization. Do not invent a universal colleague-approval requirement for ordinary documentation.

When a restricted detail cannot appear in the shared copy, keep its record in the approved restricted location. Prepare a separate handoff only when needed and authorized; never upload it alongside the broad-distribution document.

## Inspect the delivered copy
