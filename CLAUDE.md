...
The 2026-09-14 `share-internal-doc` revision supersedes its earlier mandatory outline, figure, and Markdown-source prescriptions. Its core owns reader context, supported judgment, depth, language, and preservation across media. Conditional references own structure, claim handling, sharing, and rendering. Keep the dark default for controlled screen documents and figures. The reader-question asset is a review aid, not a document template. Document preparation does not imply publication, commits, or installation; use the user's established scope. The collected private transcripts remain outside the public package.
